...
export default class RouteMap extends Component {
  ...
  makeForceChart() {
    ...
    const links = [
      ...
      { source: "expressInit1", target: 'profileMiddleware1', type: 'licensing'},
      { source: "profileMiddleware1", target: 'corsMiddleware1', type: 'licensing'},
      { source: "corsMiddleware1", target: 'jsonParser1', type: 'licensing'},
      { source: 'jsonParser1', target: 'urlencodedParser1', type: 'licensing'},
      {source: 'urlencodedParser1', target: 'cookieParser1', type: 'licensing'},
      ...
      { source: "expressInit2", target: 'profileMiddleware2', type: 'licensing' },
      { source: "profileMiddleware2", target: 'corsMiddleware2', type: 'licensing' },
      { source: "corsMiddleware2", target: 'jsonParser2', type: 'licensing' },
      { source: 'jsonParser2', target: 'urlencodedParser2', type: 'licensing' },
      { source: 'urlencodedParser2', target: 'cookieParser2', type: 'licensing' },
      ...
      { source: "expressInit3", target: 'profileMiddleware3', type: 'licensing' },
      { source: "profileMiddleware3", target: 'corsMiddleware3', type: 'licensing' },
      { source: "corsMiddleware3", target: 'jsonParser3', type: 'licensing' },
      { source: 'jsonParser3', target: 'urlencodedParser3', type: 'licensing' },
      { source: 'urlencodedParser3', target: 'cookieParser3', type: 'licensing' },
      ...
      { source: "expressInit4", target: 'profileMiddleware4', type: 'licensing' },
      { source: "profileMiddleware4", target: 'corsMiddleware4', type: 'licensing' },
      { source: "corsMiddleware4", target: 'jsonParser4', type: 'licensing' },
      { source: 'jsonParser4', target: 'urlencodedParser4', type: 'licensing' },
      { source: 'urlencodedParser4', target: 'cookieParser4', type: 'licensing' },
      ...
      { source: "expressInit5", target: 'profileMiddleware5', type: 'licensing' },
      { source: "profileMiddleware5", target: 'corsMiddleware5', type: 'licensing' },
      { source: "corsMiddleware5", target: 'jsonParser5', type: 'licensing' },
      { source: 'jsonParser5', target: 'urlencodedParser5', type: 'licensing' },
      { source: 'urlencodedParser5', target: 'cookieParser5', type: 'licensing' },
      ...
      { source: "expressInit6", target: 'profileMiddleware6', type: 'licensing' },
      { source: "profileMiddleware6", target: 'corsMiddleware6', type: 'licensing' },
      { source: "corsMiddleware6", target: 'jsonParser6', type: 'licensing' },
      { source: 'jsonParser6', target: 'urlencodedParser6', type: 'licensing' },
      { source: 'urlencodedParser6', target: 'cookieParser6', type: 'licensing' },
      ...
      { source: "expressInit7", target: 'profileMiddleware7', type: 'licensing' },
      { source: "profileMiddleware7", target: 'corsMiddleware7', type: 'licensing' },
      { source: "corsMiddleware7", target: 'jsonParser7', type: 'licensing' },
      { source: 'jsonParser7', target: 'urlencodedParser7', type: 'licensing' },
      { source: 'urlencodedParser7', target: 'cookieParser7', type: 'licensing' },
      ...
      { source: "expressInit8", target: 'profileMiddleware8', type: 'licensing' },
      { source: "profileMiddleware8", target: 'corsMiddleware8', type: 'licensing' },
      { source: "corsMiddleware8", target: 'jsonParser8', type: 'licensing' },
      { source: 'jsonParser8', target: 'urlencodedParser8', type: 'licensing' },
      { source: 'urlencodedParser8', target: 'cookieParser8', type: 'licensing' },
      ...
      { source: "expressInit9", target: 'profileMiddleware9', type: 'licensing' },
      { source: "profileMiddleware9", target: 'corsMiddleware9', type: 'licensing' },
      { source: "corsMiddleware9", target: 'jsonParser9', type: 'licensing' },
      { source: 'jsonParser9', target: 'urlencodedParser9', type: 'licensing' },
      { source: 'urlencodedParser9', target: 'cookieParser9', type: 'licensing' },
      ...
      { source: "expressInit10", target: 'profileMiddleware10', type: 'licensing' },
      { source: "profileMiddleware10", target: 'corsMiddleware10', type: 'licensing' },
      { source: "corsMiddleware10", target: 'jsonParser10', type: 'licensing' },
      { source: 'jsonParser10', target: 'urlencodedParser10', type: 'licensing' },
      { source: 'urlencodedParser10', target: 'cookieParser10', type: 'licensing' },
